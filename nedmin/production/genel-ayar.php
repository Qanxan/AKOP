            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                    ...
                    <form action="../netting/islem.php" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                if (!empty($ayarcek['ayar_logo']) && file_exists("../../" . $ayarcek['ayar_logo'])) { ?>
                                    <img width="200" src="../../<?php echo $ayarcek['ayar_logo']; ?>" alt="Logo">
                                <?php } else { ?>
                                    <img width="200" src="../../dimg/logo-yok.png" alt="Varsayılan Logo">
                                <?php } ?>
                    ...
                    <form action="../netting/islem.php" method="post" id="demo-form2" data-parsley-validate
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Site Başlığı <span
                                        class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="first-name" name="ayar_keywords"
                                       value="<?php echo $ayarcek['ayar_keywords'] ?>" required="required"
                                       class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Site Yazar <span
                                        class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
