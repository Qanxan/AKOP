...
<head>
    ...
    <title>AKOP | Ahi Kooperatifleri</title>
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>AKOP PANELİ</span></a>
                </div>
                ...
                <div class="profile clearfix">
                    ...
                    <div class="profile_info">
                        <span>Hoşgeldin</span>
                        <h2> <?php echo $kullanicicek['kullanici_unvan'] ?> </h2>
                    </div>
                </div>
                <!-- /menu profile quick info -->
                            ...
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                <li>
                                    <a>
                                        ...
                                        <span>
                                            <span>Atakan Bıyıkoğlu</span>
                                            <span class="time">3 dakika ago</span>
                                        </span>
